...
Blockly.Blocks['set_colour'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldColour("#fff"), "COLOUR");
    this.setInputsInline(true);
...
Blockly.JavaScript['pen_forward'] = function(block) {
...
Blockly.JavaScript['pen_right_turn'] = function(block) {
  var value_angle = Blockly.JavaScript.valueToCode(block, 'angle', Blockly.JavaScript.ORDER_COMMA) || 0;
...
Blockly.JavaScript['pen_left_turn'] = function(block) {
  var value_angle = Blockly.JavaScript.valueToCode(block, 'angle', Blockly.JavaScript.ORDER_COMMA) || 0;
  var code = 'BC.turn(360-' + value_angle + ');\n';
  return code;
};
...
Blockly.JavaScript['pen_get_angle'] = function(block) {
