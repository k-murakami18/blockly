...
<body>
  <header>
    <h1 class="title">課題1の評価ページ</h1>
    <p style="color:white"><?php echo $name ?>&nbsp;さんの課題</p>
    <nav>
      <ul>
        <li><a href="https://ichi-lab.net/~g231t034/blockly/PE2022/TutorTop.php?task=1&selection=<?php echo $selection ?>&u_id=<?php echo $identifier ?>" class="back_btn">前のページへ戻る</a></li>
      </ul>
    </nav>
  </header>
  ...
  <form action="PHP/CheckData.php" method="POST" enctype="multipart/form-date" name='checkdata' class='check' style="font-size: 0.9em;">
    ...
    <input type="checkbox" id="check6" name="check6" value="ok" onclick="checkbox6('item6')" style="margin:5px" require>
    学習者の履歴を確認したか<br>
    <input type="checkbox" id="check7" name="check7" value="ok" onclick="checkbox7('item7')" style="margin:5px" require>
    学習者に対して適切なコメントができているか<br>
    <input type="checkbox" id="check8" name="check8" value="ok" onclick="checkbox8('item8')" style="margin:5px" require>
    チェック漏れは無いか<br>
    <input type="hidden" name="confirmed" value="済">
    <input type="hidden" name="kadai" value="1">
