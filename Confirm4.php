...
<body>
  <header>
    <h1 class="title">課題4の評価確認ページ</h1>
    <nav>
      <ul>
        <li><a href="https://ichi-lab.net/~g231t034/blockly/PE2022/CheckTop.php?task=4&u_id=<?php echo $identifier ?>" class="back_btn">前のページに戻る</a></li>
      </ul>
    </nav>
  </header>
