...
<body>
  <header>
    <h1 class="title">課題4の評価ページ</h1>
    <p style="color:white"><?php echo $name ?>&nbsp;さんの課題</p>
    <nav>
      <ul>
        <li><a href="https://ichi-lab.net/~g231t034/blockly/PE2022/TutorTop.php?task=4&selection=<?php echo $selection ?>&u_id=<?php echo $identifier ?>" class="back_btn">前のページへ戻る</a></li>
      </ul>
    </nav>
  </header>
  ...
  <form action="PHP/CheckData.php" method="POST" enctype="multipart/form-date" name='checkdata' class='check' style="font-size: 0.9em;">
    ...
    <input type="hidden" name="kadai" value="4">
