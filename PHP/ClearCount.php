...
//最新の作業で実行したことにする
$query2 = "UPDATE blockly$task SET clear = 'clear' WHERE blockly$task.process_id = '$block_run_id';";
mysqli_query($con, $query2);
$query3 = "UPDATE comment$task SET clear = 'clear' WHERE blockly$task.process_id = '$comment_run_id';";
