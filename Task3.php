...
<body>
  <header>
    <h1 class="title">課題3のプログラム作成ページ</h1>
    <nav>
      <ul>
  ...
  <div id='checklist' class='check'>
    ...
    <textarea id="comment" name="comment" value="comment" rows="4" cols="50" style='margin:5px' placeholder="自由記述欄です。ここに記述した内容はチューターも確認します。未完成の状態で提出しても構いません。その際、分からないことなどがある場合はここからチューターに質問してみましょう。"></textarea>
    <p></p>
  </div>
  ...
  <script>
    ...
    /*　--------------------------------------------------------------- 学習者が履歴を確認する用のタブを開く ---------------------------------------------------------------------------------------*/
    function history() {
      window.open('History3.php?key=' + saveKey);
    }
